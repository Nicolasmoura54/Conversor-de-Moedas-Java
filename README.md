...
Esse é um projeto simples em Java que faz a conversão entre diferentes moedas, criado como parte de um desafio de aprendizado (Alura/Oracle ONE).
...
✔️ Conversão entre várias moedas, por exemplo:

- Dólar (USD) e Reais (BRL)
- Reais (BRL) ↔ Dólar (USD)
- Euro (EUR) e Reais (BRL)
- Euro (EUR) ↔ Dólar (USD)
